...
export const PATCH = withRoute(async (req: NextRequest, { params }: RouteParams) => {
  ...
  const allowed = [
    ...
    'boat_id','fareharbor_item_pk','chef_name','chef_bio','chef_photo_url','chef_photo_asset_id',
    ...
    'display_order','is_published','is_featured','is_listed','category','departure_location',
